...
export function Registro() {
    ...
    const oficios = ["Abogado(a)", "Administrador de empresas", "Comunicador(a)", "Docente universitario", "Estudiante", "Economista", "Fisioterapeuta",
"Ingeniero(a) ambiental/industrial/otros", "Médico ocupacional", "Operario(a)", "Psicólogo(a)", "Relacionista industrial", "Sociólogo(a)", "Ténico(a)", "Trabajador(a) social", "Otra profesión"]
        ...
        if (resLoginJson.conectado == false) {
            ...
            if(respuestaJson.registro == true){
                ...
                if(respuestaJsonLog.conectado == true){
                    setEmailUser(respuestaJsonLog.email)
        ...
        <div className='registro_container'>
            <div className='form_container'>
                <div>
                    ...
                    <input type='text' name='nombre' ref={RefNombres}>
                    </input>
                </div>
                <div>
                    <label for='apellido'>Apellidos: 
                    </label>
                    <input type='text' name='apellido' ref={RefApellidos}>
                    </input>
                </div>
                <div>
                    <label for='pais'>Pais: 
            ...
            <input className='submit' type='submit' value='Registrarme' onClick={()=>{registrarUsuario()}}>
            </input>
        </div>
    )
}
